...
This is a fork of [lwz322/k3screenctrl](https://github.com/lwz322/k3screenctrl) and [MSquach/k3screenctrl](https://github.com/MSquach/k3screenctrl), with modifications to support on OpenWrt 25.12 and later versions.

We hope to include this in the official OpenWrt repository, but for now, you can find the latest release [here](https://github.com/kazutoiris/k3screenctrl-build/releases).
